...
class DNI():
    ...
    def __init__(self, rnn_params, top_down_w1, optimizer, W_rec, alpha, batch_size, **kwargs):
    ...
    def __call__(self, h, h_prev, pol, pol_prev, lab, lab_prev, u, td_inputs, mask):
        ...
        self.update_learning_vars(h, lab, h_prev, lab_prev, dL_dz, self.q, mask)
    ...
    def update_learning_vars(self, h, label, h_prev, label_prev, dL_dz, q, mask):
        """Updates the A matrix by Eqs. (3) and (4)."""

        self.update_J_approx(h, h_prev)
    ...
    def update_J_approx(self, h, h_prev):
